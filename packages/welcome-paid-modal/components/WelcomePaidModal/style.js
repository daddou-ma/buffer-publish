...
export const DivButtonStyle = styled.div`
  position: absolute;
  right: 16px;
  bottom: 12px;
`;

export const MainDivBackgroundStyle = styled.div`
...
export const BarBottomStyle = styled.div`
  padding: 19px 0px;
  float: left;
  background-color: white;
  width: 100%;
...
export const MainDiv2Style = styled.div`
  background-color: white;
  width: 556px;
  padding-bottom: 10px;
`;
