...
module.exports = orgData => ({
  ...
  has30DaySentPostsLimitFeature: orgData.entitlements.includes(entitlements.SENT_POSTS_30_DAYS), // profiles_controller updates_sent() returns only 30 days of sent posts for free users.
  hasCalendarFeature: orgData.entitlements.includes(entitlements.CALENDAR),
  hasCustomizingUtmParamsFeature:
  orgData.entitlements.includes(entitlements.CUSTOMIZE_UTM_PARAM) && orgData.isOwner,
  ...
  hasTwitterImpressions: orgData.entitlements.includes(entitlements.TWITTER_IMPRESSIONS),
  hasAnalyticsOnPosts: orgData.entitlements.includes(entitlements.ANALYTICS_ON_POSTS),
  hasFirstCommentFeature: orgData.entitlements.includes(entitlements.FIRST_COMMENT),
  hasShareNextFeature: orgData.entitlements.includes(entitlements.SHARE_NEXT),
  hasUserTagFeature: orgData.entitlements.includes(entitlements.TAG_USERS_IN_IMAGES),
  hasPinterestFeature: orgData.entitlements.includes(entitlements.PINTEREST),
  hasCustomIgVideoCoverFeature: orgData.entitlements.includes(entitlements.CUSTOM_VIDEO_THUMBNAIL_INSTAGRAM),
  hasHashtagManagerFeature: orgData.entitlements.includes(entitlements.HASHTAG_MANAGER),
  hasProfileGroupsFeature: orgData.entitlements.includes(entitlements.CHANNEL_GROUPS_IN_COMPOSER),
  hasAccessTeamPanel: orgData.entitlements.includes(entitlements.TEAMS_PANEL) && orgData.isAdmin,
